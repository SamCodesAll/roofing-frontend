...
const data = SERVICE_DETAILS['electrical-services'];

const ElectricalServices = () => (
  <>
    <SEO title={data.title} description={data.metaDescription} path="/electrical-services" keywords={data.keywords} />
    ...
    <ProcessSteps title="Our Service Process" steps={data.process} />
    <ServiceGalleryTeaser category="Electrical Services" />
    <ServiceReviews />
